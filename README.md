...
- mongoDb up and running - have to change the path in .env file
- Redis server up and running - have to change the port and host in .env
- Winston logger directory - have to change according to requirement in .env
